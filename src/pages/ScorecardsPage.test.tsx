...
vi.mock('@/hooks/useTeams', () => ({
  useTeams: () => ({
    data: {
      count: 2,
      results: [
        { id: 'a', name: 'Team Alpha', code: 'ALP', is_active: true },
        { id: 'b', name: 'Team Beta', code: 'BET', is_active: true },
      ],
    },
    isLoading: false,
    isError: false,
...
describe('ScorecardsPage', () => {
  it('renders scorecard cards and team pair filter', () => {
    ...
    expect(screen.getByRole('button', { name: /swap teams/i })).toBeInTheDocument();
