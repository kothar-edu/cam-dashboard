...
const current = { over: 2, ball: 0, inning: 1, runs: 0, wickets: 0, target: 0, crr: 0, balls_remaining: 0, required_runs: 0, rrr: 0, status: 'IN_PROGRESS', projected: 0 };
...
describe('PowerplayBadge', () => {
  ...
  it('renders nothing once the powerplay has ended', () => {
    const { container } = render(<PowerplayBadge current={{ ...current, over: 6 }} powerplayOvers={6} />);
